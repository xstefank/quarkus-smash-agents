    ...
    public static class TextAssertion {
        ...
        public TextAssertion satisfies(List<String> conditions) {
            ...
            try {
                ...
                List<String> failures = getFailures(conditions, conditionAssessments);
        ...
        private List<String> getFailures(List<String> conditions, ConditionAssessments conditionAssessments) {
